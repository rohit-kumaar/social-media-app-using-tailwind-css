...
function Profile() {
  ...
  return (
    <div className="profile bg-bgSoft">
      ...
      {/* Container Start  */}
      <div className="profileContainer py-5 px-[70px]">
        <div className="userInfo mb-5 flex h-[240px] items-center justify-between rounded-[20px] bg-white p-[50px] text-black shadow-lg">
          {/* Left Start  */}
          ...
          {/* Center Start  */}
          <div className="center flex flex-1 flex-col items-center pt-3">
            <span className="text-[30px] font-medium">Jane Doe</span>
            <div className="info mb-2 flex w-full items-center justify-around">
